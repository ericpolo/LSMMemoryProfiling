...
#pragma endregion
  ...
  options->linklist_if_log_bucket_dist_when_flash = env->linklist_if_log_bucket_dist_when_flash;
  options->linklist_threshold_use_skiplist = env->linklist_threshold_use_skiplist;
